package tom.objects.tileentity;
...
import tom.objects.machines.BlastFurnaceRecipes;
...
public class TileEntityBlastFurnace extends TileEntity implements ITickable
{
	...
	private ItemStack blasting = ItemStack.EMPTY;
	...
	{	
		...
		{
			if(!this.isBurning() && this.canBlast())
			{
		...
		if(this.isBurning() && this.canBlast() && cookTime > 0)
		{
			cookTime++;
			if(cookTime == totalCookTime)
			{
				...
				{
					handler.insertItem(3, blasting, false);
				}

				blasting = ItemStack.EMPTY;
				cookTime = 0;
				return;
			}
		}
		...
		{
			if(this.canBlast() && this.isBurning())
			{
