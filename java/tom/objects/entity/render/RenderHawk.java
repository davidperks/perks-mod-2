...
{
	public static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MODID + ":textures/entity/hawk.png");

	public RenderHawk(RenderManager rendermanagerIn) 
	{
