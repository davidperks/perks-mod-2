...
public class ModelBirdOfPrey extends ModelPerksAnimals

{
	...
	public void renderBirdOfPrey(EntityBirdOfPrey parBird, float parRenderFloat)
	{
        ...
        if (parBird.getState() == AIStates.STATE_PERCHED || parBird.getState() == AIStates.STATE_PERCHED_TAMED)
        {
	...
	public void setRotationAngles(EntityBirdOfPrey parEntity)
	{
		...
		else if (parEntity.getState() == AIStates.STATE_PERCHED || parEntity.getState() == AIStates.STATE_PERCHED_TAMED)
		{
			doAnimate(parEntity, perchedCycle);
		}
		else if (parEntity.getState() == AIStates.STATE_SOARING || parEntity.getState() == AIStates.STATE_SOARING_TAMED)
		{
			doAnimate(parEntity, soaringCycle);
		}
        else if (parEntity.getState() == AIStates.STATE_TRAVELLING || parEntity.getState() == AIStates.STATE_SEEKING)
        {
