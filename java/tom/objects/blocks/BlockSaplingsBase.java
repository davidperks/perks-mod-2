...
public class BlockSaplingsBase extends BlockBush implements IHasModel, IGrowable
{
	...
	public BlockSaplingsBase(String name) 
	{
		super(Material.ROCK);
  ...
  //Variants
  	...
  	public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
  	{
  		...
  		{
  		case "ruby":
  			gen = new WorldGenRubyTree();
  			break;
  		case "titanium":
  			gen = new WorldGenTitaniumTree();
  			break;
  		}
