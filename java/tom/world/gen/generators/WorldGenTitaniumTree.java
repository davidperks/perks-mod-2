...
public class WorldGenTitaniumTree extends WorldGenAbstractTree
{

	public static final IBlockState LOG = BlockInit.LOG_TITANIUM.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES_TITANIUM.getDefaultState();

	private final int minHeight;

	public WorldGenTitaniumTree() 
	{
		super(false);
		this.minHeight = 12;
	}
