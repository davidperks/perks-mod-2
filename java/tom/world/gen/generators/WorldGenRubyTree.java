...
public class WorldGenRubyTree extends WorldGenAbstractTree 

{

	public static final IBlockState LOG = BlockInit.LOG_RUBY.getDefaultState();
	public static final IBlockState LEAF = BlockInit.LEAVES_RUBY.getDefaultState();

	private final int minHeight;

	public WorldGenRubyTree() 
	{
		super(false);
		this.minHeight = 12;
	}
