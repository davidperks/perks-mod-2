package tom.world.dimension.library.chunks;
...
public class ChunkGeneratorLibrary implements IChunkGenerator
{
    ...
    */
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
        	//fireFeature.generate(world, this.rand, new BlockPos(x * 16, this.rand.nextInt(120), z * 16));
        }
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.RUBY);
        }
    ...
    private double[] getHeights(double[] noiseField, int x, int y, int z, int xSize, int ySize, int zSize)
    {
        ...
        if (event.getResult() == InitNoiseField.Result.DENY) return event.getNoisefield();
